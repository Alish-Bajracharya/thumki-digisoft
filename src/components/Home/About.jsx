      ...
      <div className="relative container mx-auto px-6 md:px-12">
        ...
        >
          <p className="uppercase tracking-widest text-sm md:text-base font-semibold">
            Welcome to{" "}
            <span className="font-extrabold text-amber-400">Thumki</span> Resort
          </p>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-20">
          ...
          {/* Right Text Section */}
          <motion.div
            className="flex-1 bg-white/95 backdrop-blur-sm shadow-lg p-6 md:p-10 space-y-6 rounded-lg border-l-4 border-l-amber-400"
            initial={{ opacity: 0, x: 80 }}
            whileInView={{ opacity: 1, x: 0 }}
          ...
          >
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mt-3">
              The Peak of{" "}
              <span className="italic text-amber-400">Luxury</span> in Bagmati
              Province
            </h1>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 rounded-full font-semibold shadow-md transition duration-300"
            >
              Discover Our Story
            </motion.button>
          </motion.div>
